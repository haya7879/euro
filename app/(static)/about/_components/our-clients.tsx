        ...
        <div className="w-full">
          ...
          <div className="border border-gray-200 rounded-3xl md:p-5 p-2.5 flex flex-col lg:flex-row gap-8">
            ...
            <div className="w-full lg:w-1/2 flex flex-col gap-2.5">
              ...
              <div className="flex items-center gap-3 border border-gray-200 rounded-xl px-4 py-2.5 hover:border-[#3E5EC0] hover:shadow-md transition-all">
              ...
              <div className="flex items-center gap-3 border border-gray-200 rounded-lg px-4 py-2.5 hover:border-[#3E5EC0] hover:shadow-md transition-all">
                <div className="w-6 h-6 flex items-center justify-center">
